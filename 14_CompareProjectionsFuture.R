...
invisible(sapply(scenarios,function(scen){
  
  luMap <- readRDS(paste(luDir,"2070MapLandUseScenario",scen,".rds",sep=""))
  luClimMap <- readRDS(paste(luClimDir,"2070MapLandUseAndClimateScenario",scen,".rds",sep=""))
  ...
  png(filename = paste(outDir,"DifferenceMapScenario",scen,".png",sep=""),

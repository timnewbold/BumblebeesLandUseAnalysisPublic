...
outDir <- "8_ProjectModelsLandUseAndClimateNoClimateChange/"
...
png(filename = paste(outDir,"2005MapLandUseAndClimateNoClimateChange.png",sep=""),width = 17.5,height = 13.5,units = "cm",res = 1200)
...
saveRDS(object = pred_2005_propn,file = paste(outDir,"2005MapLandUseAndClimateNoClimateChange.rds",sep=""))
